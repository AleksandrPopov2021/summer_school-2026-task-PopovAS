...
> *Секция опциональна. Указывать, если на экране используется переиспользуемая бизнес-логика из раздела [09_Logics](09_Logics/_INDEX.md).*

| Логика | Элемент/Триггер | Описание |
|--------|-----------------|----------|
| [LOGIC-XXX {Название}](../09_Logics/LOGIC-XXX_{Название}.md) | {Кнопка / Элемент} | {Краткое описание логики} |
...
> - **Логика:** Описывается после таблицы каждого блока в виде текстового блока "**Логика:**". Если элемент использует переиспользуемую логику из раздела [09_Logics](09_Logics/_INDEX.md), укажите ссылку на неё.
...
**Логика:**
- {Элемент}: [LOGIC-XXX](../09_Logics/LOGIC-XXX_{Название}.md) — {краткое описание логики}
